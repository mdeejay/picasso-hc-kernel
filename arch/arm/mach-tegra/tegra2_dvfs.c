...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 314, 314, 314, 456, 456, 608, 608, 760, 817,  912,  1000, 1200, 1408, 1504, 1600, 1704),
	CPU_DVFS("cpu", 1, 1, MHZ, 314, 314, 314, 456, 456, 618, 618, 770, 827,  922,  1000, 1200, 1408, 1504, 1600, 1704),
	CPU_DVFS("cpu", 1, 2, MHZ, 494, 675, 675, 675, 817, 817, 922, 1000, 1200, 1408, 1504, 1600, 1704),
	CPU_DVFS("cpu", 1, 3, MHZ, 730, 760, 845, 845, 1000, 1200, 1408, 1504, 1600, 1704),
#else
